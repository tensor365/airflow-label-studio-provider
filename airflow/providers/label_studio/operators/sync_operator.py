...
class ImportSyncTask(BaseOperator):
    ...
    def execute(self, context: Dict[str, Any]) -> Any:
        ...
        response = hook.ImportSyncTask(idSyncTask=self.idTask, idProject=self.idProject, syncType=self.syncType)
...
class ExportSyncTask(BaseOperator):
    """
    Trigger a Sync Task in Label Studio.
    ...
    def execute(self, context: Dict[str, Any]) -> Any:
        ...
        self.log.info("Call HTTP method to reload task with id {}".format(self.idTask))
        response = hook.ExportSyncTask(idSyncTask=self.idTask, idProject=self.idProject, syncType=self.syncType)
